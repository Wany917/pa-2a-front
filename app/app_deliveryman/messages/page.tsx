...
export default function MessagesPage() {
	...
	const [activeTab, setActiveTab] = useState<'all' | 'client' | 'shopkeeper'>(
		'all'
	);
	...
	const [conversations, setConversations] = useState<Conversation[]>([
		...
		},
		{
			...
			lastMessage:
				'I can take care of your children this Saturday from 7 PM.',
			...
			messages: [
				{
					...
					senderName: 'You',
					content:
						'Hi Emma, are you available for baby-sitting this Saturday evening?',
				...
				},
				{
					...
					senderName: 'Emma',
					content:
						"Hello! Yes, I'm available. What time do you need me?",
				...
				},
				{
					...
					senderName: 'You',
					content:
						'Great! We need someone from 7 PM to midnight. Is that okay?',
				...
				},
				{
					...
					senderName: 'Emma',
					content:
						'Do you need me to prepare dinner for them or will they have eaten already?',
			...
			messages: [
				{
					...
					senderName: 'Lucas',
					content:
						"Hello, I'm assigned to deliver your package #ECO-87654321.",
				...
				},
				{
					...
					senderName: 'You',
					content:
						'Hi Lucas, thanks for letting me know. When will you pick it up?',
				...
				},
				{
					...
					senderName: 'Lucas',
					content:
						"I've picked up your package from the storage box.",
			...
			messages: [
				{
					...
					content:
						"Hello! I'm here to pick up Max for his dog-sitting session.",
				...
				},
				{
					...
					senderName: 'You',
					content:
						"Hi Charlotte! I'll bring him down in a minute. He's very excited!",
				...
				},
				{
					...
					senderName: 'Charlotte',
					content:
						"No problem, I'll wait outside. Does he need his special food today?",
				...
				},
				{
					...
					senderName: 'You',
					content:
						"Yes, I'll pack it with his leash and toys. Thanks for asking!",
							...
							{isUserMenuOpen && (
								<div className='absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg z-10 py-2 border border-gray-100'>
									...
									>
										...
										<span>
											{t(
												'deliveryman.switchToClientAccount'
											)}
										</span>
									</Link>
				...
				<main className='container mx-auto px-4 py-8'>
					...
					<div className='bg-white rounded-lg shadow-md overflow-hidden'>
						<div className='flex flex-col md:flex-row h-[calc(80vh-100px)]'>
							...
							{/* Conversation Detail */}
							<div
								className={`w-full md:w-2/3 flex flex-col ${!selectedConversation ? 'hidden md:flex' : 'flex'}`}
							>
								{!currentConversation ? (

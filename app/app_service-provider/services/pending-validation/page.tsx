...
// Remplacez le chemin par l'emplacement de votre GIF dans /public ou /assets
      ...
      <Card className="bg-white rounded-2xl shadow-xl max-w-2xl w-full">
        <CardContent className="p-8 flex flex-col items-center space-y-6">
          <h1 className="text-2xl font-bold text-center">
            {t("serviceProvider.pendingThanksTitle")}
          </h1>
          <div className="text-center text-gray-700 space-y-2">
            <p>{t("serviceProvider.pendingMessageLine1")}</p>
            <p>{t("serviceProvider.pendingMessageLine2")}</p>
          </div>
          <img
            src={gifSrc}
            alt="Quality work"

            ...
            <div className="flex items-center space-x-4">
              ...
              >
                ...
                <span className="text-gray-500">
                  {formData.idCard ? formData.idCard.name : t("service-provider.uploadIdCard")}
                </span>
              </label>
              <input
                id="idCard"
          ...
          <div>
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                <Upload className="h-5 w-5 text-gray-500 mr-2" />
                <span className="text-gray-500">
                  {formData.drivingLicence ? formData.drivingLicence.name : t("service-provider.uploadDrivingLicence")}
                </span>
              </label>
              <input
                id="drivingLicence"
